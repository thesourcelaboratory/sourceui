...
tinymce.PluginManager.add('textcolor', function(editor) {
	...
	rows = {
		...
		cellcolor: editor.settings.cellcolor_rows || editor.settings.textcolor_rows || 5
	};
	cols = {
		...
		cellcolor: editor.settings.cellcolor_cols || editor.settings.textcolor_cols || 8
	};
	...
	function addCellColor(value){
		var $selectedCells = editor.$('td[data-mce-selected], th[data-mce-selected]');
		if ($selectedCells.length){
			$selectedCells.css({
				'background-color':value,
				'color':lumineeColor(value)
			});
			$selectedCells.removeAttr('data-mce-selected');
		}
		console.log('addCellColor', value, $selectedCells);
	}
	function clearCellColor(){
		...
		console.log('clearCellColor',$selectedCells);
	}
