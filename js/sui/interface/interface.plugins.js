...
sourceui.interface.plugins = function(){
	...
	var Userguide = this.userguide = {
		...
		close : function(){
			...
			$guides.velocity({opacity:[0,1], scale:[0.75,1]},{duration:250, complete:function(){
				$userguide.html('');
			}});
		},
	...
	var Notify = this.notify = {
		...
		close: function($cur){
			...
			Dom.notifyContainer.velocity({ opacity: [0,1], translateY: [75,0]},{ duration: 220, complete:function(){
				Dom.notifyContainer.removeClass('active');
				Dom.notifyContainer.html('');
			}, display: 'none'},'easeOutQuad');
		},
	...
	var Sector = this.sector = {
		...
		float : function(setup){
			...
			$close.one('click',function(event){
				...
				$container.velocity({ opacity:[0,1] },{ display:'none', duration:250, complete:function(){
					$container.html('');
				} });
